...
from models.bertie import BertIe
from models.zamie import ZamIe
...
ENT, TYPE, VALUE, VALUE_TEXT, TEXT = data.make_fields(
    args.maxlen + 1, bert="bert" in args.model)
